...
export default function PresupuestoPage() {
  return (
    <main className="min-h-screen bg-ajcar pt-24 sm:pt-32 pb-10 sm:pb-12 px-4 sm:px-6 relative overflow-hidden">
      {/* Overlay semitransparente para oscurecer la imagen de fondo y mejorar la legibilidad */}
      <div className="absolute inset-0 bg-black/40 pointer-events-none" />

      <div className="max-w-3xl mx-auto relative z-10">
        {/* Encabezado: título con acento en rojo y subtítulo descriptivo */}
        ...
        {/* Contenedor del formulario con fondo oscuro y efecto de cristal */}
        ...
        {/* Aviso legal de privacidad y contacto posterior al envío */}
